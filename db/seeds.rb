...
admin_test = Admin.create_with(name: 'Admin', lastname: 'Phoenix',password: 'test1234', password_confirmation: 'test1234').find_or_create_by!(email: 'admin@email.com')
...
project2 = Project.create_with(dream: 'comprar un apto', description: 'comprar un apartamento', money: 350000000, monthly_payment: 1500000, month: 48, approved: true, warranty: 0, interest_rate: 1.35, investor_id: investor1.id, account_id: '1212121212', client_id: client1.id, initial_payment: Date.new + 5.day, new_project: false, approved_date: Date.new, code: '1234', finished: false, matched: true).find_or_create_by!(dream: 'comprar un apto')
