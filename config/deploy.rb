...
set :ssh_options,     { forward_agent: true, user: fetch(:user), keys: %w(~/.Keys/faiber-phx) }
...
#sudo ln -nfs /home/faiber/apps/api/current/config/nginx.conf /etc/nginx/conf.d/api.conf