class ProjectsController < ApplicationController
  ...
  def index
    ...
    render json: @projects,meta: pagination_dict(@projects), each_serializer: ProjectSerializer, status: :ok, include: ["client.cons", "client.pros"]
  end
  ...
  def show
    if @project
      render json: @project, serializer: ProjectSerializer, include: ["client.cons", "client.pros"]
    else
      error_not_found
    end
  end
